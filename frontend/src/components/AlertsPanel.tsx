...
export function AlertsPanel() {
  ...
  return <section className="alerts-panel panel">
    <div className="panel-heading"><div><div className="eyebrow">CLOSE-APPROACH ALERTS</div><h2>Which satellites need attention <span>{alerts.length.toString().padStart(2, "0")}</span></h2></div><span className="live-dot">LIVE</span></div>
